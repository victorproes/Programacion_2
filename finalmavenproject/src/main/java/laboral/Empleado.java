...
public class Empleado extends Persona {
	...
	public Empleado(String nombre, String dni, String sexo) throws DatosNoCorrectoExcpetion {
		super(nombre, sexo, dni);
		this.categoria = 1;
		this.anyos = 0;
	}

	public Empleado(String nombre, String dni, String sexo, int categoria, int anyos) throws DatosNoCorrectoExcpetion {
		super(nombre, sexo, dni);
